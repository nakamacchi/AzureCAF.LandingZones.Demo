...
do
  echo "Trying to create DCR ${TEMP_DCR_ASA_NAME}..."
  sleep 10
  TEMP=$(az monitor data-collection rule create --name ${TEMP_DCR_ASA_NAME} --resource-group "${TEMP_RG_NAME}" --location "${TEMP_LOCATION_NAME}" --rule-file dcr.json 2>&1)
done
