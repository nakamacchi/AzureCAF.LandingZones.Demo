...
--name "Spoke F Maintenance" --rule-type ApplicationRule --collection-priority 50699 --action Allow \
--rule-name "GitHub" \
...
--resource-group "${TEMP_RG_NAME}" --policy-name "${TEMP_FWP_NAME}" --rcg-name "AdditionalApplicationRuleCollectionGroup" \
--collection-name "Spoke F Maintenance" --rule-type ApplicationRule \
--name "WslStore" \
