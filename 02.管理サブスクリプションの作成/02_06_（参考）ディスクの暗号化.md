...
- ADE (Azure Disk Encryption)
  - **ADE (Azure Disk Encryption) は、2028/09/15 に廃止予定になりました([詳細](https://azure.microsoft.com/ja-jp/updates?id=493779))**　このため、今後の VM 作成には他の方式を利用してください。（参考のために、情報としては残しておきます）
